    ...
    <div className="bg-gradient-to-br from-indigo-900 via-blue-900 to-purple-800 text-white py-16 px-8 md:px-20 lg:px-40">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl leading-relaxed mb-8">
          Uplift is dedicated to supporting small and medium-sized enterprises (SMEs) across Africa. Our mission is to provide a seamless platform for business management, enabling SMEs to track their sales, manage inventory, and optimize their operations.
        </p>
