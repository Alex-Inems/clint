...
export default function PrivacyPage() {
  return (
    <main className="max-w-3xl mx-auto py-12 px-4">
      ...
      <p className="mb-4">
        donatr respects your privacy. This policy explains how we collect, use, and protect the information you provide.
      </p>
      ...
      <p className="mb-4">
        You can request access, correction, or deletion of your information at any time by emailing support@donatr.org.
      </p>

      <h2 className="text-2xl font-semibold mt-8 mb-4">6. Contact</h2>
      <p className="mb-4">
        Questions about this Privacy Policy? Contact us at support@donatr.live
      </p>
    </main>
  );
}
