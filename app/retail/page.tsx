  ...
  const cardsData = [
    {
      ...
      description:
        "Uplift enables you to accept a wide range of payment methods, from cash to integrated card systems, ensuring a seamless checkout experience for your customers.",
    ...
    },
    {
      ...
      description:
        "Monitor and manage your inventory effortlessly with Uplift’s real-time tracking. Avoid stockouts and overstocking while keeping your resources optimized.",
    ...
    },
    {
      ...
      description:
        "Get detailed insights into your sales performance with Uplift’s powerful analytics tools, helping you make informed business decisions.",
    ...
    },
    {
      ...
      description:
        "Keep your customers engaged and satisfied with Uplift’s integrated CRM tools. Build lasting relationships and drive repeat business.",
    ...
    },
    {
      ...
      description:
        "Protect your business and customer data with Uplift’s state-of-the-art security features. We use encryption and multi-factor authentication to ensure safe transactions and data privacy.",
    ...
    },
    {
      ...
      description:
        "Tailor Uplift to fit your business needs with customizable settings. From payment options to user permissions, you can configure the platform to suit your unique requirements.",
